---
name: durable-memory
description: Curate durable Markdown memories. Use when proposing, reviewing, or applying a durable memory change; not for lookup or session history.
---
...
- **Merge** when records are true duplicates. Similarity alone is not enough; compare scope, qualifiers, dates, and retrieval purpose.
...
- Never create a root-level `project/`; use `core/project/`.
