...
export function loadConfig(): ExtensionConfig {
	...
	try {
		...
		if (config.projectResources !== undefined && config.projectResources !== "inherit" && config.projectResources !== "ignore") {
			throw new Error(`Subagent config at '${configPath}' has invalid projectResources policy`);
		}
