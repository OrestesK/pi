...
import { findPiLensProjectConfig, loadPiLensProjectConfig, } from "./project-lens-config.js";
...
function buildProjectIgnoreMatcher(resolvedRoot, patterns) {
    ...
    const patternsForDir = (dir) => {
        ...
        if (cached?.gitignoreMtimeMs === gitignoreMtime)
