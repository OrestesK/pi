...
export class TreeSitterClient {
    ...
    async runQueryOnFile(queryDef, filePath, languageId, options = {}, contentOverride) {
        ...
        const compiled = await this.compileRawQuery(queryDef.id, queryDef.query, queryDef.metavars, queryDef.language || languageId, queryDef.post_filter, queryDef.post_filter_params);
        if (!compiled)
            return [];
    ...
    applyPostFilter(postFilter, postFilterParams, captures) {
        /**
