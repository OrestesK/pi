 ...
 * ```
 */
export function getRunnerTimeoutFloorMs() {
    if (_runnerTimeoutFloorCache !== undefined)
 ...
 */
export function _resetRunnerTimeoutFloorCacheForTests() {
