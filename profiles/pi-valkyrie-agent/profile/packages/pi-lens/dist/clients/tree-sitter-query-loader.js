 ...
 */
export function ruleSourceLanguages(languageId) {
 ...
 */
export function ruleFilesForLanguage(languageId, rootDir = process.cwd()) {
 ...
 */
export function queriesForLanguage(queries, languageId) {
