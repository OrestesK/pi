...
| [`DietrichGebert/ponytail`](https://github.com/DietrichGebert/ponytail)           | Reuse-before-build decision order and minimum-code-after-understanding framing; paraphrased, not copied.                            |
