...
export function handleList(params: ManagementParams, ctx: ManagementContext): AgentToolResult<Details> {
	...
	const lines = [
		...
		"",
		"Tool access:",
		"- Tools are agent-specific, not inherited from the parent. Protected advisory roles strip MCP, mutation, and extension tools.",
		"- Use { action: \"get\", agent: \"name\" } for discovered config; use a write-capable agent for writes or a configured non-advisory agent for MCP/custom tools. Normal approval/privacy gates still apply.",
		"",
